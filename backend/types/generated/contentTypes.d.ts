...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    adminEmailStatus: Schema.Attribute.Enumeration<
      ['pending', 'sent', 'failed']
    > &
    ...
    inquiryType: Schema.Attribute.Enumeration<
      ['General', 'Support', 'Partnership', 'Feedback']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publicReference: Schema.Attribute.String & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userEmailStatus: Schema.Attribute.Enumeration<
      ['pending', 'sent', 'failed']
    > &
      Schema.Attribute.DefaultTo<'pending'>;
  };
